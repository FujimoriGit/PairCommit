...
- **役割ごとに別のアクセント色を置く。** 管理者は藍、プレイヤーは紫。ロールは端末ごとに固定なので、片方の画面に出るのは常に同じ1色で、これだけでは見た人に自分の役割を教えない。2色が同じ場に並ぶのは、2人が端末を並べたときと役割を選ぶ画面だけで、色の役目はそこで別の側だと分かることにある。暖色を使わないのは、感情リアクションが赤・橙・緑を占めているため。役割色をそこへ寄せると、行の色が感情を指しているのか役割を指しているのか読めなくなる。
